...
export default function Modal() {
  ...
  return (
    ...
    >
      <div className="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all sm:max-w-lg sm:w-full m-5 sm:mx-auto min-h-[calc(100%-3.5rem)] flex justify-center items-center">
        <div className="flex flex-col bg-[#e8e8e8] border shadow-sm rounded-xl">
          <div className="flex justify-end items-center pt-2 px-4">
            <button
              type="button"
